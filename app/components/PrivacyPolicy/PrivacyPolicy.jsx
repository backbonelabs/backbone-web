    ...
    <Paper zDepth={1}>
      <div>
        ...
        <div>
          ...
          <p>
            The Personal Data we collect and the purposes for which we use it include the
            following:
          </p>
          <ul>
            <li>
            ...
            <li>
              <h3>Analytics</h3>
              <p>
                We may aggregate and de-identify data so that the data does not identify you and
                use it for a variety of analytical purposes, such as understanding and improving the
