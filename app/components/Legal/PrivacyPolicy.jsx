  ...
  <Container className="legal__outer-container">
    <Panel>
      ...
      <div>
        ...
        <p>
          And remember, we’re here to help. If something in this policy does not make sense or if you have any questions, please contact us at <a href="mailto:support@gobackbone.com">support@gobackbone.com</a>.
        </p>
      </div>
      <div>
        <h2>When We Collect Data</h2>
        <h4>ACTIVATE A DEVICE</h4>
        <p>
        ...
        <h4>CREATE A BACKBONE LABS ACCOUNT</h4>
        <p>
      ...
      <div>
        <h4>ADD INFO TO YOUR ACCOUNT</h4>
        <p>
      ...
      <div>
        ...
        <h4>DATA THAT COULD IDENTIFY YOU</h4>
        <p>
        ...
        <h4>DATA THAT DOES NOT IDENTIFY YOU (DE-IDENTIFIED DATA)</h4>
        <p>
        ...
        <h4>DATA THAT YOU DIRECT US TO SHARE</h4>
        <p>
      ...
      <div>
        ...
        <h4>BACKBONE LABS SOCIAL TOOLS</h4>
        <p>
